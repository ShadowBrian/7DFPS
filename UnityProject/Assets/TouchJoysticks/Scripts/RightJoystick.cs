...
public class RightJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public virtual void OnDrag(PointerEventData ped)
    {
        ...
        inputVector = new Vector3(ped.delta.x, ped.delta.y, 0);
        ...
        //{
            ...
            */
            /*Vector3 inputVectorOld = new Vector3(localPoint.x * 2 + 1, localPoint.y * 2 - 1, 0);
            ...
            inputVectorOld = (inputVectorOld.magnitude > 1.0f) ? inputVectorOld.normalized : inputVectorOld; // normalizes the vector, this will be used to ouput to a game object controller to control movement (for example, of a player character or any desired game object)

            // moves the joystick handle "knob" image
            joystickKnobImage.rectTransform.anchoredPosition =
             new Vector3(inputVectorOld.x * (bgImage.rectTransform.sizeDelta.x / joystickHandleDistance),
                         inputVectorOld.y * (bgImage.rectTransform.sizeDelta.y / joystickHandleDistance));
